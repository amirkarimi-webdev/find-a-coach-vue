    ...
    <div>
        ...
        <base-card>
            <form @submit.prevent="submitForm">
                ...
                <p v-if="!formIsValid">please enter a valid email and password (must be at least 6 charecters long)</p>
        ...
        methods: {
            async submitForm() {
                ...
                try {
                    ...
                    this.error = err.message || 'failed to authenticated , try again letter'
                }
